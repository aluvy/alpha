<template>
  <div class="container">
    <div class="content" id="content">
      ...
      <div class="section ty02">
        <h3 class="tit03">요금제 꼼꼼하게 찾기 sample</h3>
        ...
        <div class="filter_wrap">
          ...
          <div class="check_wrap">
            ...
            <button type="button" class="filter_detail" id="btn_PR01PG00" @click="this.$emit('openPopup', ['PR01PG00', 'btn_PR01PG00', 101]);">꼼꼼하게 찾기</button>
          </div>
