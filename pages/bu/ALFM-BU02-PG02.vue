    ...
    <div class="content" id="content">
      ...
      <div class="page_info">결제수단을 <br>선택해주세요</div>
        <div class="form_wrap">
            ...
            <div class="form_item">
              <div class="box_gray box_price">
                ...
                <div class="count">
                  ...
                  <button class="plus" id="countPlusBtn" @click="plus()"><span class="blind">추가</span></button>
                </div>
              </div>
            </div>
            <div class="form_item">
          ...
          <div class="form_group">
            <strong class="form_label">결재수단</strong>
            <div class="form_item">
      ...
      <div class="bottom_float">
        <div class="inner">
          <div class="float_btn_wrap">
            <div class="btn_group">
              <button type="button" class="btn lg c01" disabled>결제하기</button>
            </div>
          </div>
        </div>
      </div> <!-- // bottom_float -->
