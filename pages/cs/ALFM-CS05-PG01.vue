    ...
    <div class="content" id="content">
      ...
      <div class="section ty02">
        ...
        <div class="form_group">
          ...
          <PopupSelect ref="inquiryType" :option="{ data:'inquiryType', popupTitle:'문의유형 선택', targetBtn:'btn_inquiryType' }" @selectItem="console.log($event)" />
        </div>
        
        <div class="form_group">
          <strong class="form_label">제목</strong>
          <div class="form_item">
            <InputBox :option="{ placeholder:'제목을 입력해주세요' }" @inputValue="console.log($event)" />
          </div>
        ...
        <div class="form_group">
          ...
          <div class="form_item">
            ...
            <TextareaBox :data="{ type:'ty01', placeholder:'문의 내용을 입력해 주세요', maxlength: 1000, byteCheck: true, }"
        ...
        <div class="form_group">
          <div class="box_gray">
            <ul class="text_list bull">
              <li>
                입력하신 이메일 주소로 문의에 대한 답변을 보내 드리고 
                있으니, 정확히 입력해 주세요.
              </li>
            </ul>
          </div>
