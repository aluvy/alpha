    ...
    <div class="content" id="content">
      ...
      <div class="section">
        <div class="invite_event">
          ...
          <h3 class="tit02"><sup>+</sup>알파 요금제 가입이력 인증</h3>
          <div class="form_wrap">
            <div class="form_group">
              <strong class="form_label">이름</strong>
              <div class="form_item"> <!-- class="form_item val_chk" 유효성 check -->
                <InputBox :option="{ placeholder:'+알파에서 개통 시 등록한 이름' }" @inputValue="console.log($event)" />
              </div>
...
export default {
  ...
  data(){
    return {
      layout: { header: 'sub2', footer: '', floatMenu: '', title: '친구 추천 이벤트' },
      tableShow: true,
      dataTable:[
