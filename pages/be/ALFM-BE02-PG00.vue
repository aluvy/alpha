        ...
        <div class="evt_dtl_item">
          <div class="evt_dtl_tit">
            ...
            <div class="dtl_tit_bot">
              ...
              <div class="share_box">
                <span><span>{{ startDay }}</span> - <span>{{ endDay }}</span></span>
          ...
          <div class="evt_dtl_con"><!-- .evt_close 이벤트 종료 시 -->
            <div class="box_gray">
              본 이벤트는 종료되었습니다
            </div>
            <div>
              <img src="/images/data/img_evt_detail.png" alt="이벤트 상세">
            </div>
          </div>

          <hr style="display:none"><!-- 댓글 있을때 display:none -->

          <div class="evt_comnt">
            <TextareaBox :data="{ type:'ty02', placeholder:'댓글을 남겨주세요(50자 이내)', rows:1, maxlength: 50, byteCheck: true, button: true, buttonValue:'등록', }" 
