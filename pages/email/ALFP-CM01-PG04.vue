    ...
    <div style="border-width:0 1px 1px 1px; border-style:solid; border-color:#EAEAEA;">
      <div style="padding:32px 31px 60px;">
        ...
        <div style="padding-top:12px;">
          <table width="100%" style="border-top:1px solid #000; border-spacing:0; font-family:'Malgun Gothic', 'Dotum';">
            <tbody>
              ...
              <tr>
                <th style="height:55px; width:130px; padding:0 0 0 8px; text-align:left; font-weight:normal; font-size:13px; color:#717171; letter-spacing:-0.045rem; border-bottom:1px solid #ddd">작성자</th>
                <td style="padding:0; font-size:13px; color:#000; border-bottom:1px solid #ddd; letter-spacing:-0.045rem;">홍*동</td>
              </tr>
              <tr>
        ...
        <div style="padding-top:32px; text-align:center; white-space:nowrap; font-size:0; line-height:20px;">
          <NuxtLink to="#" target="blank" style="display:inline-block; font-family:'Malgun Gothic', 'Dotum'; padding:14px 30px; border-radius:8px; text-align:center; background:#FC6969; color:#fff; font-size:16px; font-weight:bold; text-decoration:none; letter-spacing:-0.075rem;">1:1 문의내역 답변 보러가기</NuxtLink>
        </div>
      </div>
