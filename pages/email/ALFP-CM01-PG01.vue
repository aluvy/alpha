      ...
      <div style="padding:32px 31px 60px;">
        ...
        <div style="padding-top:12px;">
          <table width="100%" style="border-top:1px solid #000; border-spacing:0; font-family:'Malgun Gothic', 'Dotum';">
            <tbody>
              <tr>
                <th style="height:55px; width:130px; padding:0 0 0 8px; text-align:left; font-weight:normal; font-size:13px; color:#717171; letter-spacing:-0.045rem; border-bottom:1px solid #ddd">탈퇴일</th>
